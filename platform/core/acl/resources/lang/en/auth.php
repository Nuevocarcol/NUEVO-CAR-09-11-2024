...
return [
    'login' => [
        ...
        'login' => 'Ingresar',
        'placeholder' => [
            'username' => 'Ingrese email o Usuario',
            'email' => 'Ingrese email',
            'password' => 'Ingrese Password',
        ],
        'success' => 'Credenciales Correctas!',
        'fail' => 'Credenciales Incorrectas.',
        'not_active' => 'No Tiene Acceso al Modulo, si crees que es un error, comunicate con NuevoCar',
    ...
    'sign_in_below' => 'Modulo de Publicación de Vehiculos',
    'languages' => 'Languages',
