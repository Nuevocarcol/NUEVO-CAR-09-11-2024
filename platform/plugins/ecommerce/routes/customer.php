...
use Botble\Ecommerce\Http\Controllers\Customers\ConcesionarioController;
...
Theme::registerRoutes(function () {
    Route::group([
        ...
        Route::get('/concesionario', [ConcesionarioController::class, 'showConcesionarioForm'])->name(
            'concesionario'
        );
        Route::post('registercon', [ConcesionarioController::class, 'registerConcesionario'])->name('registercon.post');
    ...
    Route::middleware('customer')
        ...
        ->group(function () {
            ...
            // Add Routes for publications

            Route::prefix(EcommerceHelper::getPageSlug('customer_publications'))->group(function () {
                Route::get('/', [
                    'as' => 'publications',
                    'uses' => 'ProductPublicController@index',
                ]);
