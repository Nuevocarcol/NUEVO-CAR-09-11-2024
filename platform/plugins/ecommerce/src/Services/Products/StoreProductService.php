...
class StoreProductService
{
    public function execute(Request $request, Product $product, bool $forceUpdateAll = false): Product
    {
        ...
        //dd($request->input('product_label'));
        if (! $product->productLabels()->where('product_label_id', $request->input('product_label'))->exists()) {
            $product->productLabels()->attach($request->input('product_label'));
        }
        //$product->productLabels()->attach($request->input('product_label'));
