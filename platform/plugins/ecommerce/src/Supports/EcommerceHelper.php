...
class EcommerceHelper
{
    ...
    public function getCitiesName(): array
    {
        return City::query()
            ->wherePublished()
            ->orderBy('order')
    ...
    /**
     * Consultar el codigo de descuento por concesionario
     * @author miguel Rodriguez
     * @since 30 de Diciembre 2024
     */
    public function buscarDescuento($phone) {
    ...
    public function buscarProductousuario($id){
        ...
        if ($customer == null) {
            return [
                'email' => $usuario->email,
                'phone' => null // No hay teléfono asociado
            ];
        } else {
            return [
                'email' => $usuario->email,
    ...
    /**
     * Consultar productos por atributos
     * @author miguel rodriguez
     * @since 4 de Enero 2025
     */
    ...
    /**
     * Consultar ciudad por usuario
     * @author miguel rodriguez
     * @since 8 de Enero 2025
     */
    ...
    public function getDefaultPageSlug(?string $key = null): array|string|null
    {
        $default = [
            ...
            'customer_publications' => 'customer/publications',
