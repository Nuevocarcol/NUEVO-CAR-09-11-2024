...
namespace FriendsOfBotble\MercadoPago\MercadoPago\Client;
...
use FriendsOfBotble\MercadoPago\MercadoPago\Net\MPRequest;
use FriendsOfBotble\MercadoPago\MercadoPago\Net\MPResponse;
