...
namespace FriendsOfBotble\MercadoPago\MercadoPago;

use FriendsOfBotble\MercadoPago\MercadoPago\Exceptions\InvalidArgumentException;
use FriendsOfBotble\MercadoPago\MercadoPago\Net\MPDefaultHttpClient;
