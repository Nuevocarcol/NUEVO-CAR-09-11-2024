...
class ReceiverAddress
{
    ...
    private $map = [
      'city' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\MerchantOrder\ReceiverAddressCity",
      'state' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\MerchantOrder\ReceiverAddressState",
      'country' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\MerchantOrder\ReceiverAddressCountry",
    ];
