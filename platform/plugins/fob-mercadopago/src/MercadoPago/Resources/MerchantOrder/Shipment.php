...
class Shipment
{
    ...
    private $map = [
      'receiver_address' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\MerchantOrder\ReceiverAddress",
      'shipping_option' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\MerchantOrder\ShippingOption",
    ];
