...
class ShippingOption
{
    ...
    private $map = [
      'estimated_delivery' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\MerchantOrder\ShippingEstimatedDelivery",
      'speed' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\MerchantOrder\ShippingSpeed",
    ];
