...
class AdditionalInfo
{
    ...
    private $map = [
      'payer' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\Payment\AdditionalInfoPayer",
      'shipments' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\Payment\Shipments",
    ];
