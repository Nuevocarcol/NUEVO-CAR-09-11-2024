...
class PaymentSearchResult
{
    ...
    private $map = [
        'payer' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\Payment\Payer",
        'fee_details' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\Payment\FeeDetails",
        'additional_info' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\Payment\AdditionalInfo",
        'transaction_details' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\Payment\TransactionDetails",
        'card' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\Payment\Card",
        'point_of_interaction' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\Payment\PointOfInteraction",
        'payment_method' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\Payment\PaymentMethod",
        'metadata' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\Payment\Metadata",
        'three_ds_info' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\Payment\ThreeDSInfo",
    ];
