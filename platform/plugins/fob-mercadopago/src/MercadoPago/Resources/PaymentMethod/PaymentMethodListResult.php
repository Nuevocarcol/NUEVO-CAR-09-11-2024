...
class PaymentMethodListResult
{
    ...
    private $map = [
        'settings' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\PaymentMethod\Settings",
        'financial_institutions' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\PaymentMethod\FinancialInstitutions",
    ];
