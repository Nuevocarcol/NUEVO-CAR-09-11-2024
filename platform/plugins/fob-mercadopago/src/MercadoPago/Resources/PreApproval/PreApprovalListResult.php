...
namespace FriendsOfBotble\MercadoPago\MercadoPago\Resources\PreApproval;
...
class PreApprovalListResult
{
    ...
    public $map = [
        'auto_recurring' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\PreApproval\AutoRecurring",
        'summarized' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\PreApproval\Summarized",
    ];
