...
class PreApprovalPlan extends MPResource
{
    ...
    public $map = [
        'auto_recurring' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\PreApprovalPlan\AutoRecurring",
        'payment_methods_allowed' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\PreApprovalPlan\PaymentMethodsAllowed",
    ];
