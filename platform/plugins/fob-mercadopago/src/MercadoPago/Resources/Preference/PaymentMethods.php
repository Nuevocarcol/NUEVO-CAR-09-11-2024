...
class PaymentMethods
{
    ...
    private $map = [
        'excluded_payment_methods' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\Preference\PaymentMethod",
        'excluded_payment_types' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\Preference\PaymentType",
    ];
