...
class Shipments
{
    ...
    public $map = [
      'free_methods' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\Preference\FreeMethod",
      'receiver_address' => "FriendsOfBotble\MercadoPago\MercadoPago\Resources\Preference\ReceiverAddress",
    ];
